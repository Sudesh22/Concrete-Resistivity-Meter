...
void W25Q_Read (uint32_t memAddr, uint32_t size, uint8_t *rData)
{
	uint8_t tData[5];
...
void W25Q_Write_NUM (uint32_t Addr, float data)
{
...
float W25Q_Read_NUM (uint32_t Addr)
{
	uint8_t rData[4];
	W25Q_Read(Addr, 4, rData);
