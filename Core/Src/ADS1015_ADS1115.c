...
int16_t ADSreadADC_Differential_0_1_Continuous(ADS1xx5_I2C *i2c) {
    // Start with default values
	uint16_t config =
	    ADS1015_REG_CONFIG_CQUE_NONE    |    // Disable the comparator (default)
	    ...
	    ADS1015_REG_CONFIG_DR_1600SPS   |    // 1600 samples per second (adjust as needed)
